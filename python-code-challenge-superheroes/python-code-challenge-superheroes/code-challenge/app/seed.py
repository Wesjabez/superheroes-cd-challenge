...
with app.app_context():
    ...
    hero1 = Hero(name="Kamala Khan", super_name="Ms. Marvel", powers=[power1, power2])
    hero2 = Hero(name="Doreen Green", super_name="Squirrel Girl", powers=[power1, power3])
    hero3 = Hero(name="Gwen Stacy", super_name="Spider-Gwen", powers=[power2])
